...
/// <summary>
/// DIRIS Readings API controller for time series data
/// </summary>
[ApiController]
[Route("api/diris/readings")]
public class DirisReadingsController : ControllerBase
{
    private readonly IDeviceRegistry _deviceRegistry;
    private readonly ILogger<DirisReadingsController> _logger;
    private readonly string? _connectionString;

    public DirisReadingsController(
        IDeviceRegistry deviceRegistry,
        ILogger<DirisReadingsController> logger,
