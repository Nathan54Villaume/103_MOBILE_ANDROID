...
/// <summary>
/// DIRIS System metrics collector implementation
/// </summary>
public class DirisSystemMetricsCollector : ISystemMetricsCollector
{
    ...
    public DirisSystemMetricsCollector()
    {
        _currentProcess = Process.GetCurrentProcess();
        _startTime = DateTime.UtcNow;
    }

    public Diris.Core.Models.SystemMetrics GetCurrentMetrics()
    {
        var processUptime = DateTime.UtcNow - _startTime;
        var systemUptime = TimeSpan.FromMilliseconds(Environment.TickCount64);

        // Get process metrics
        var processMetrics = new Diris.Core.Models.ProcessMetrics
        {
        ...
        // Get system metrics
        var systemInfo = new Diris.Core.Models.SystemInfo
        {
        ...
        var gcMetrics = new Diris.Core.Models.GcMetrics
        {
        ...
        return new Diris.Core.Models.SystemMetrics
        {
